...
@section('contentPagePerso')
    ...
    <div class="form bg-white shadow-sm px-6 py-6 min-height">
        <form enctype="multipart/form-data" action="{{route('professionnelArea.updateAvatar', Auth::user()->id)}}"
            method="POST" style="max-width: 500px;margin: auto;margin-bottom: 25px;">
            <div class="title">
                    <h2 class="mb-4">Mes informations personnelles</h2>
            </div>
            ...
            <input type="submit" class="pull-right btn btn-sm btn-pr">
        </form>

        <form enctype="multipart/form-data" action="{{route('professionnelArea.update', Auth::user()->id)}}"
            method="POST">
            @csrf
            ...
            <div class="form-group justify-content-center row">
                <div class="col-lg-6 col-md-12">
                    ...
                    <input id="adresse" type="text" class="form-control @error('adresse') is-invalid @enderror"
                        name="adresse" value="@isset($user){{$user->adresse}}@else{{ old('adresse') }}@endisset">
                ...
                <div class="col-lg-6 col-md-12">
                    ...
                    <input id="city" list="cities" name="city"
                        class="form-control input-search @error('city') is-invalid @enderror"
                        value="@isset($user->city->name_ville){{ $user->city->name_ville }}@endisset">
                    <datalist id="cities">
            ...
            <div class="form-group justify-content-center row">
                <div class="col-lg-12 col-md-12">
                    ...
                    <textarea id="about" class="form-control @error('about') is-invalid @enderror"
                        name="about">@isset($user){{$user->about}}@else{{ old('about') }}@endisset</textarea>
