...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function appelAjax() {
    fetch('/tempo/json').then(function (response) {
      ...
      if (pros.length) {
        ...
        try {
          for (var _iterator = pros[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
            var pro = _step.value;
  ...
  formPros.addEventListener('keyup', function (e) {
    ...
    try {
      ...
      for (var _iterator2 = tabPros[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        _loop();
      }
    } catch (err) {
...
__webpack_require__(/*! C:\Users\dcuomo\Desktop\easyRDV\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\dcuomo\Desktop\easyRDV\resources\sass\app.scss */"./resources/sass/app.scss");
